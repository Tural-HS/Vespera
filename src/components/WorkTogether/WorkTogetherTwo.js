...
const { image, tagline, title, icon, text, text2, text3 } = workTogetherTwo;
...
const WorkTogetherTwo = () => {
  ...
  <Col xl={6} lg={6}>
    <div className="work-together-tow__right">
      ...
      <div className="work-together-tow__content">
        ...
        <h3 className="work-together-tow__text" style={{ textAlign: 'justify' }}>{text}</h3>
      </div>
  ...
  <div style={{ width: '100%', textAlign: 'justify' }}>
    ...
    <p className="work-together-tow__text-3">{text3}</p>
  </div>
</div>
