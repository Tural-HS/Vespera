...
export const servicesOne = {
  ...
  services: [
    {
      id: 1,
      title: "Global Expertise in Commodity Trading:",   

      image: "services-1.jpg",
      icon: "icon-creative",
      href: "/consumer-product",
      text: "Situated strategically in Dubai, hub for many trading houses and financial institutions all around the world, Vespera enjoys a competitive edge in the international trading landscape. Our team provides expertise across the full chain of traded goods such as crude oil, refined products, positioning us as an indispensable link between global suppliers and end-users/customers. ",
    },
    {
      id: 2,
      title: "Holistic \n Trading \n Solutions:",
      ...
      text: "Vespera's deep-seated understanding of the nuances inherent in the crude oil and oil products.\n Recognizing the importance of flexibility in today's dynamic market environment, Vespera offers an expansive array of crude oil and oil product selections from multiple loading ports, ensuring bespoke solutions that resonate with our clients' distinct requirements.",
    },
    {
      id: 3,
      title: "Expansive Market Presence and Vision:",
      image: "services-3.jpg",
      icon: "icon-global",
      href: "/marketing-rules",
      text: "Our expansive footprint spans pivotal markets encompassing Asia, the Middle East, Turkey, and Africa. Vespera's unwavering commitment to excellence empowers us to adeptly navigate these diverse landscapes, strategically positioning our commodities to fulfill the evolving needs of our multifaceted clientele.",
    },
    // {
    //   id: 4,
    //   title: "Business \n Growth",
